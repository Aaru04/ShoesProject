...
// save it to session
List<CartItem> cartItems =newArrayList<CartItem>();
...
publicString cartAddItem(ModelMap map, javax.servlet.http.HttpServletRequest request,
...
BigDecimal dprice = item.getRate().multiply(newBigDecimal(item.getQty()));
...
*@return
*/
privateBigDecimal getCartValue(List<CartItem> list){
